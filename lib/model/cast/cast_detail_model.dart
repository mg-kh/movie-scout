...
CastDetailModel castDetailModelFromJson(String str) => CastDetailModel.fromJson(json.decode(str));

String castDetailModelToJson(CastDetailModel data) => json.encode(data.toJson());
