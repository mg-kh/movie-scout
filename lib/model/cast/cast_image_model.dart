...
//
//     final castImageModel = castImageModelFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

CastImageModel castImageModelFromJson(String str) => CastImageModel.fromJson(json.decode(str));

String castImageModelToJson(CastImageModel data) => json.encode(data.toJson());
...
class CastImageModel {
  ...
  factory CastImageModel.fromJson(Map<String, dynamic> json) => CastImageModel(
