...
import 'package:movie/services/popular_tv_show/popular_tv_show_api_service.dart';
...
class PopularTvShowController extends GetxController {
  ...
  Future getPopularTvShowData({pageNumber: 1, genreId: 28}) async {
    isErrorOccur(true);
    ...
    try {
      var movie = await PopularTvShowApiService()
          .remoteGetPopularTvShowData(pageNumber: pageNumber);
