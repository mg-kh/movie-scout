...
class SearchPersonApiService{
  ...
  Future remoteSearchPersonData({required query})async{
    var url = Uri.parse('https://api.themoviedb.org/3/search/person?api_key=$apiKey&language=en-US&page=1&include_adult=${settingController.getAdultContent()}&query=$query');
